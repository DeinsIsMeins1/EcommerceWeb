...
@Component({
  ...
  animations: [
    trigger('fade', [
      ...
      transition(':enter, :leave', animate('1000ms ease-out'))
    ])
  ]
})
export class AdminPage implements OnInit {
  ...
  obtenerInfoUser() {
    ...
    console.log('----ESTATUS',this.cargado);
